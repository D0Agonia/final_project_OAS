...
function filterComment($input){
    // Filter for comments, with leniency over most characters
...
function filterControlNumber($input){
    // Filter for 13 digit control number
    $filter = '/^\d{13}$/';
...
function filterGuest($input){
    // 'GUESTxxxxxx' regex filter, with x being a number
    $filter = '/^GUEST[0-9]{6}$/';
